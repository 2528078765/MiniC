...
1. 前往 [Releases](https://github.com/2528078765/MiniC/releases) 下载 `MiniC-Setup-0.0.5.exe`（版本 0.0.5）。
...
- 下载 `MiniC-0.0.5-windows-x64.exe`，双击即用（不写注册表、无需安装）；其余使用方式同上。
...
ISCC.exe packaging\MiniC.iss                             # 生成安装包 dist\MiniC-Setup-0.0.5.exe（Inno Setup 6）
```
